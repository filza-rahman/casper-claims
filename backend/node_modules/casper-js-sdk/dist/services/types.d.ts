...
export type ReactorState = 'Initialize' | 'CatchUp' | 'Upgrading' | 'KeepUp' | 'Validate' | 'ShutdownForUpgrade';
...
export type TransformValue = 'Identity' | {
    WriteAccount: string;
...
export interface JsonStoredContract extends JsonBasicExecutionDeployItemInternal {
    entry_point: string;
}
...
export interface JsonStoredVersionedContractByName extends JsonStoredContractByName {
    version: number | null;
}
export interface JsonStoredVersionedContractByHash extends JsonStoredContractByHash {
    version: number | null;
}
