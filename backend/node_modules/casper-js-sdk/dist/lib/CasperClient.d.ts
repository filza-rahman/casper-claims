...
import { BlockIdentifier, CasperServiceByJsonRPC, GetDeployResult } from '../services';
...
import { CasperHDKey } from './CasperHDKeys';
export declare class CasperClient {
     ...
     */
    newHdWallet(seed: Uint8Array, algo: SignatureAlgorithm): CasperHDKey<AsymmetricKey>;
    /**
     ...
     * @param signedDeploy Signed deploy object
     */
    speculativeDeploy(signedDeploy: Deploy, blockIdentifier: BlockIdentifier): Promise<any>;
    /**
